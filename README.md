...
<details>
  <summary>:zap: Our Features :zap:</summary>
  
<!--START_SECTION:activity-->
1.) Ray Casting. (Ambition 270)

2.) Add a display of real date and time in the Heads Up Display. (Ambition 90)

3.) Add support for 2 users to interact at the same time. (Ambition 90)

4.) Make your engine render images instead of unicode characters. (Ambition 90)

5.) New/Save/Load/Quit Game
...
4.) 2 Pandora boxes (1 give you extra points, 1 make you die right away).
...
<!--END_SECTION:activity-->
 ...
 ### 👊 Game Rules
<details>
  <summary>:zap: The Rule :zap:</summary>
  
<!--START_SECTION:activity-->
1.) Collect Potion to make Covid19 Vaccine in the given time

2.) Who has the most coins shall be our hero.

3.) But, be careful, there are 2 Pandora boxes

4.) One makes you the hero, the other turn you to a sinner
